  ...
  return (
    <div className="bg-white border border-[#E8E8E3] rounded-xl overflow-hidden"
      ...
      <div className="flex px-4 py-2 border-b border-gray-100">
        <div className="flex-[2] text-xs font-medium text-gray-400 uppercase tracking-wider">Employee</div>
        <div className="flex-[1.5] text-xs font-medium text-gray-400 uppercase tracking-wider">Change</div>
        <div className="flex-1 text-xs font-medium text-gray-400 uppercase tracking-wider text-right">Impact</div>
        <div className="flex-[2.5] text-xs font-medium text-gray-400 uppercase tracking-wider pl-6">Details</div>
      </div>
      ...
      <div className="flex items-center px-4 py-4 border-b border-gray-50 hover:bg-gray-50/50 transition-colors">
        ...
        <div className="flex-1 text-right">
          <span className="text-sm font-mono text-emerald-600">+$4,231.00</span>
        </div>
        <div className="flex-[2.5] pl-6">
      ...
      <div className="flex items-center px-4 py-4 border-b border-gray-50 hover:bg-gray-50/50 transition-colors">
        ...
        <div className="flex-1 text-right">
          <span className="text-sm font-mono text-red-500">-$3,892.00</span>
        </div>
        <div className="flex-[2.5] pl-6">
      ...
      <div className="flex items-center px-4 py-4 border-b border-gray-50 hover:bg-gray-50/50 transition-colors">
        ...
        <div className="flex-1 text-right">
          <span className="text-sm font-mono text-emerald-600">+$417.00</span>
        </div>
        <div className="flex-[2.5] pl-6">
      ...
      >
        <div className="flex items-center px-4 py-4 bg-red-50/60 hover:bg-red-50/80 transition-colors">
          ...
          <div className="flex-1 text-right">
            <span className="text-sm font-mono text-red-600 font-semibold">+$12,400.00</span>
          </div>
          <div className="flex-[2.5] pl-6 flex items-center justify-between gap-2">
